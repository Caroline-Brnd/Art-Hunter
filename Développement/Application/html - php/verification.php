...
if(isset($_POST['nom_utilisateur']) && isset($_POST['mot_de_passe']))
{
 ...
 header('Location: evenement.html');
 }
 else
 {
 header('Location: co-app.php?erreur=1'); // utilisateur ou mot de passe incorrect
 }
 }
 else
 {
 header('Location: co-app.php?erreur=2'); // utilisateur ou mot de passe vide
 }
}
else
{
 header('Location: co-app.php');
}
